...
use crate::analysis::{BlockCategory, AnalysisDepth, OutputSchema, I18nText, AnalysisBlockConfig};
...
pub fn ai_summary_block() -> AnalysisBlockConfig {
    AnalysisBlockConfig {
        ...
        supported_modes: vec![AnalysisDepth::Quick, AnalysisDepth::Full],
        default_mode: AnalysisDepth::Quick,
        order: 1,
        depends_on: None,
...
pub fn algorithms_block() -> AnalysisBlockConfig {
    AnalysisBlockConfig {
        ...
        default_mode: AnalysisDepth::Full,
        order: 7,
        depends_on: None,
